from multiprecessing import Process, Lock, Value
import random
import os
...
if __name__ == "__main__":
    ...
    for i in range(cpus):
        ...
        procesos.append(Process(target=montecarlo,arges=(N,resultado,lock)))
    ...
    print("Número de aciertos ", resultadovalue)
