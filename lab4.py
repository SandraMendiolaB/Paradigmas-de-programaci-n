...
#=================================
# Una clase para un bojeto vacío
# NO está tan vacío, necesita
# la paabra pass = pasar
#=================================
class ObjetoVacio:
    pass
...
class Estudiante:
    ...
    def ponerme_nombre(mi, nombre):
        print('se llamó a poneme_nombre')
        mi.__nombre = nombre
...
# (sin tener que llamar explícitamente a función obtener_nombre)
#================================================================
...
#====================================
# Su hijo rectángulo
# Rectámgulo es hijo de Cuadrilátero
# Rectngulo(Cuadrilatero)
#====================================
...
#======================================
# La clase A tiene trs números reales
#======================================
class A:
    __a:float=0.0
    __b:float=0.0
...
#======================================
# La clase B tiene don número reales
#======================================
class B:
    __d:float=0.0
    __e:float=0.0
